...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/66172c74d42127370d178.jpg",
                                caption=Config.START_MSG.format(event.from_user.mention),
                                reply_markup=InlineKeyboardMarkup([
                                    [InlineKeyboardButton("Our Movie Channel", url="https://t.me/worldofmovies8"),
...
async def inline_handlers(_, event: Message):
    if event.text == '/start':
        return
    answers = f'**📂 Searching Results For ➠ {event.text} \n\nFree Tips 😜\n\n ➠ If Your Movie Will Not Come Than Chek Spelling And Contact Owner \n\n**'
